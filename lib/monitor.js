...
async function checkPosition(mint, pos, currentPrice, swap, wallet, cfg, notify, api, forceReason = null) {
  ...
  if ((reason === 'stop-loss' || reason === 'trailing-stop') && !forceReason && _feedBase) {
    ...
    if (jupSolPrice !== null) {
      ...
      // Jupiter confirms or is below stop-loss → proceed immediately with the exit
    }
