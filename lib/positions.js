...
// Compute P&L from a per-token price expressed in SOL (i.e. priceNative from DexScreener).
// Do NOT pass a USD price — entryPrice is stored as SOL/token and the result would be nonsense.
// For full SOL-value P&L (what the monitor uses), compute: currentPrice * uiTokenAmount - solSpent.
